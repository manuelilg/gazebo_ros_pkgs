...
namespace gazebo
{
  ...
  class ElevatorPluginPrivate
  {
    ...
    public: class DoorController
    {
      ...
      /// controlled.
      public: DoorController(physics::JointPtr _doorJoint, float moveDistance = 1.0);
    ...
    public: class CloseState : public State
    {
      ...
      public: CloseState(std::vector<ElevatorPluginPrivate::DoorController*> *_ctrl);
//    public: CloseState(ElevatorPluginPrivate::DoorController *_ctrl);
      ...
      public: std::vector<ElevatorPluginPrivate::DoorController*> *ctrl;
//    public: ElevatorPluginPrivate::DoorController *ctrl;
    ...
    public: class OpenState : public State
    {
      /// \brief Constructor.
      /// \param[in] _ctrl Elevator door controller
      public: OpenState(std::vector<ElevatorPluginPrivate::DoorController*> *_ctrl);
...
//      public: ElevatorPluginPrivate::DoorController *ctrl;
    ...
    public: std::vector<physics::JointPtr> doorJoints;
//    public: physics::JointPtr doorJoint;
    ...
    public: std::vector<DoorController*> *doorControllers;
//    public: DoorController *doorController;
    ...
    /// \brief The distance the door joint moves to the open state.
    public: float doorJointMoveDistance;
  };
}
#endif
